...
# Load the data
trial <- read_csv(here::here("fitting-exercise/data/Mavoglurant_A2121_nmpk.csv")) #MJ: updating this with here function so I can load your data
