...
############################
#### Third model fit
# fit linear model using height as outcome and prefered exercise type and resting heart rate as predictor

lmfit3 <- lm(Height ~ `Preferred exercise type` + `Resting Heart Rate`, mydata)  
