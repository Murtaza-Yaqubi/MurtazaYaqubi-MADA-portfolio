...
MJ: Boxplot of Prefered exercise type and Height

```{r}
p5 <- mydata %>% ggplot(aes(x=`Preferred exercise type`, y=Height)) + geom_boxplot()
plot(p5)
figure_file = here("starter-analysis-exercise","results","figures","preferred exercise type-height.png")
ggsave(filename = figure_file, plot=p5)
```

MJ: scatterplot of weight and Resting Heart Rate

```{r}
p6 <- mydata %>% ggplot(aes(x=Weight, y=`Resting Heart Rate`)) + geom_point() + geom_smooth(method='lm')
plot(p6)
figure_file = here("starter-analysis-exercise","results","figures","weight-resting heart rate.png")
