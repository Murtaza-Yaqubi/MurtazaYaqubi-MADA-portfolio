...
MJ: preferred exercise type should be a categorical/factor variable but it is loaded as character.

```{r}
d4$`Preferred exercise type` <- as.factor(d4$`Preferred exercise type`)
