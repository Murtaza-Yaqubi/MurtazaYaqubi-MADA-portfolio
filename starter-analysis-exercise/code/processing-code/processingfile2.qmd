...
MJ: Race should be a categorical/factor variable but it is loaded as character.
MJ: It is good practice if you are using abbreviations in data to explicitly state in the codebook what each abbreviation stands for.
MJ: W = White, B = Black, A = Asian, L = Latino
...
MJ: since BMI is a calculation of Height and Weight, the data here doesn't really make much sense. 
MJ: Since this is a toy example, I think it can be disregarded but this should be considered in future analyses.
